...
namespace Rock.Model
{
    ...
    public partial class StreakTypeService
    {
        ...
        /// <summary>
        /// Handles the interaction record. Do not use this method if there is a chance the Context could be disposed. e.g. if this method is being run in a new Task.
        /// </summary>
        /// <param name="interaction">The interaction.</param>
        [RockObsolete("1.11")]
