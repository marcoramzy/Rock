...
namespace Rock.Migrations
{
    ...
    public partial class AddCacheControlHeaderToPage : Rock.Migrations.RockMigration
    {
        ...
        public override void Up()
        {
            ...
            Sql( @"
                UPDATE [Page]
                SET CacheControlHeaderSettings = 
	                CASE WHEN OutputCacheDuration > 0 
	                THEN '{""RockCacheablityType"":0,""MaxAge"":{""Value"":' + CAST(OutputCacheDuration AS varchar(50)) + ',""Unit"":0},""MaxSharedAge"":null}' 
